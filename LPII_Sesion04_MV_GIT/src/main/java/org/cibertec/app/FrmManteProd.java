...
public class FrmManteProd extends JFrame {
	...
	private void seleccionarCategoriaPorId(JComboBox<Categoria> combo, int idCategoria) {
	    for (int i = 1; i < combo.getItemCount(); i++) { // empezamos en 1
	...
	void buscar() {
	    ...
	    if (objProd == null) {
	        ...
	        seleccionarCategoriaPorId(
	            cboCategorias,
	            objProd.getCategoria().getIdCategoria()
	        );

	        seleccionarProveedorPorId(
	            cboProveedores,
	            objProd.getProveedor().getIdProveedor()
	        );
	    }
	}	
}